...
// searchMediaSaga is not entirely different from normal functions except the way it 
// handles async tasks.

// call is a redux-saga effect that instructs the middleware to run a specified 
// function with an optional payload.